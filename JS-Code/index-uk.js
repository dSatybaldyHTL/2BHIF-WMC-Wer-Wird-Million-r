...
function restartQuiz() {
    accountBalance = 0;
    document.getElementById('Balance').textContent = `Account balance: 0 £`;
    questionCounter = 0;
    currentLevelIndex = 0;
    resetPrizeList();
...
function showEndScreen(messageTop, messageBody) {
    ...
    if (!document.getElementById('endGameContainer')) {
        ...
        endGameContainer.innerHTML = `
            ...
            <button id="homepageButton" style="padding: 10px 20px; font-size: 18px; background-color: #f44336; color: white; border: none;">To homepage</button>
        `;
...
function showGameOver() {
    showEndScreen("❌ Game Over!", "You gave an incorrect answer. Would you like to try again?");
}
    ...
    fetch('http://localhost:3000/questions')
        ...
        .then(questions => {
            ...
            function loadQuestion(question) {
                ...
                document.getElementById('questionNumber').textContent = `Question ${questionCounter + 1} – Profit: ${prizes[questionCounter]} £`;
            ...
            document.getElementById('nextButton').onclick = () => {
                ...
                if (questionCounter < selectedQuestions.length) {
                    ...
                    showEndScreen("🎉 Quiz finished!", "You have successfully completed the game!");
                }
